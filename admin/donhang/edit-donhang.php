<div class="col-md-8">
  ...
  <form action="?act=updatedh" method="post">
    ...
    ?>
    <div class="mb10">
      <label for="name" class="form-label">Mã đơn hàng</label><br>
      <input style="width: 90%;" type="text" class="form-control" name="iddh" value="<?= $bill_id; ?>" readonly> <br>

      <label for="name" class="form-label">Tình trạng đơn hàng</label><br>
      <select  style="width: 90%;" class="form-select" name="ttdh" aria-label="Default select example">
